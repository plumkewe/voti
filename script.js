...
function buildMaterieList(data) {
    ...
    data.forEach(row => {
        ...
        if (!materieMap[materia]) materieMap[materia] = {
            scritto: 0,
            orale: 0,
            pratico: 0
        };
    ...
    [{
            nome: 'Scritto',
            count: totalCounts.scritto
        },
        {
            nome: 'Orale',
            count: totalCounts.orale
        },
        {
            nome: 'Pratico',
            count: totalCounts.pratico
        }
    ].forEach(({
        nome,
        count
            ...
            options: {
                ...
                scales: {
                    ...
                    x: {
                        ticks: {
                            display: false
                        }, // se vuoi nascondere asse x, altrimenti metti color: 'white'
                        grid: {
                            display: false
                        }
                    }
